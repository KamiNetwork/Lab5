...
function loadPlayersPage() {
	...
	for(playerIndex = 0; playerIndex < players.length; playerIndex++){
		...
		document.getElementById("player_selector").innerHTML += "<a class=\"dropdown-item\" href=\"#\"onclick=\"switchPlayers(" + playerIndex + ")\"id=\"" + playerIndex + "\">" + players[playerIndex].name + "</a>"
	}
}
function switchPlayers(playerNum) {
	...
	if(players[playerNum].receiving_yards == "Freshman")
	{
		var yearint = 1;
	} else if(players[playerNum].receiving_yards == "Sophomore") {
		var yearint = 2;
	} else if(players[playerNum].receiving_yards == "Junior") {
		var yearint = 3;
	} else {
		var yearint = 4;
	}
	document.getElementById("avg_p_yards").innerHTML = players[playerNum].pass_yards / yearint;
	document.getElementById("avg_r_yards").innerHTML = players[playerNum].rushing_yards / yearint;
	document.getElementById("avg_rec_yards").innerHTML = players[playerNum].receiving_yards / yearint;
}